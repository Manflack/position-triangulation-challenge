package ar.com.manflack.mercadolibre.domain.util;
...
public final class CircleCircleIntersection
{
	...
	public static enum Type
	{
		...
		COINCIDENT(-1), CONCENTRIC_CONTAINED(0), ECCENTRIC_CONTAINED(0), INTERNALLY_TANGENT(1), OVERLAPPING(
				2), EXTERNALLY_TANGENT(1), SEPARATE(0);
	...
	public final MyVector radicalPoint;
	public final double distanceC1cRadicalLine;
	public final double distanceC2cRadicalLine;
	public final MyVector versorC1cC2c;
	public final MyVector versorRadicalLine;

	// Results valid for tangent circles:
	public final MyVector intersectionPoint;

	// Results valid for overlapping circles:
	public final MyVector intersectionPoint1;
	public final MyVector intersectionPoint2;
	...
	public CircleCircleIntersection(Circle c1, Circle c2)
	{
		...
		MyVector vectorC1cC2c = c2.c.sub(c1.c);
		// Distance between circle centers:
		distanceC1cC2c = vectorC1cC2c.mod();

		// If circles are concentric there is no radical line, handle the case
		// here:
		if (distanceC1cC2c == 0)
		{
			if (c1.r == c2.r)
		...
		// Signed distances from circle centers to radical line (the direction
		// to the
		// other center is positive):
		...
		// Direction versor of radical line (points to the left if looking from
		// c1
		// center to c2 center):
		...
		// Square of distance between radical point and either intersection
		// point, if
	...
	public List<MyVector> getIntersectionPoints()
	{
		switch (type.getIntersectionPointCount())
		{
			case 0:
				return null;
			case 1:
				return Arrays.asList(intersectionPoint);
			case 2:
	...
	{
		return getClass().getSimpleName() + "(c1: " + c1 + ", c2: " + c2 + ", type: " + type + ", distanceC1cC2c: "
				+ distanceC1cC2c + ", radicalPoint: " + radicalPoint + ", distanceC1cRadicalLine: "
				+ distanceC1cRadicalLine + ", distanceC2cRadicalLine: " + distanceC2cRadicalLine + ", versorC1cC2c: "
				+ versorC1cC2c + ", versorRadicalLine: " + versorRadicalLine + ", intersectionPoint: "
				+ intersectionPoint + ", intersectionPoint1: " + intersectionPoint1 + ", intersectionPoint2: "
				+ intersectionPoint2 + ", distanceRadicalPointIntersectionPoints: "
